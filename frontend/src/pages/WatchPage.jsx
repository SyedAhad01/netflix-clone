...
<div className="flex justify-between items-centermb-4">
  <button className={`
    bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-2 rounded ${currentTrailerIdx === 0 ? 
...
<button className={`
    bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-2 rounded ${currentTrailerIdx === trailers.length-1 ? 
    'opacity-50 cursor-not-allowed' : " "
     }}
    `}
